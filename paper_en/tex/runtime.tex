...
The contents of memory after the pointer to the object table is dependent on the
...
Call to an external function in Spiral program invokes a C functions of the
